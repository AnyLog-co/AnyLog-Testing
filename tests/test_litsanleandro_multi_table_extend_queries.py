...
EXPECTED_DIR = os.path.join(ROOT_DIR, 'expect', 'lit_san_leandro_multi_table_extend_queries')
ACTUAL_DIR = os.path.join(ROOT_DIR, 'actual', 'lit_san_leandro_multi_table_extend_queries')
...
class TestLitSanLeandroSingleTableQueries:
    ...
    def test_row_count(self):
        ...
        """
        query = 'sql %s include=(percentagecpu_sensor) and extend=(@table_name as table) and format=json and stat=false "SELECT COUNT(*) FROM ping_sensor"'
        headers = {
    ...
    def test_aggregates_min_value(self):
        ...
        :assert:
            min value returned
        """
        query = 'sql %s include=(percentagecpu_sensor) and extend=(@table_name as table) and format=json and stat=false "SELECT MIN(value) FROM ping_sensor"'
        headers = {
            'command': query % self.configs['dbms'],
            'User-Agent': 'AnyLog/1.23',
            'destination': 'network'
    ...
    def test_aggregates_avg_value(self):
        ...
        :assert:
            avg value returned
        """
        query = 'sql %s include=(percentagecpu_sensor) and extend=(@table_name as table) and format=json and stat=false "SELECT AVG(value) FROM ping_sensor"'
        headers = {
            'command': query % self.configs['dbms'],
            'User-Agent': 'AnyLog/1.23',
            'destination': 'network'
    ...
    def test_aggregates_max_value(self):
        ...
        :assert:
            max value returned
        """
        query = 'sql %s include=(percentagecpu_sensor) and extend=(@table_name as table) and format=json and stat=false "SELECT MAX(value) FROM ping_sensor"'
        headers = {
            'command': query % self.configs['dbms'],
            'User-Agent': 'AnyLog/1.23',
            'destination': 'network'
    ...
    def test_aggregates_sum_value(self):
        ...
        :assert:
            avg value returned
        """
        query = 'sql %s include=(percentagecpu_sensor) and extend=(@table_name as table) and format=json and stat=false "SELECT SUM(value) FROM ping_sensor"'
        headers = {
            'command': query % self.configs['dbms'],
            'User-Agent': 'AnyLog/1.23',
            'destination': 'network'
    ...
    @pytest.mark.skip('Failed to execute DISTINCT(value) with multiple tables')
    def test_aggregates_distinct_value(self):
        ...
        """
        query = 'sql %s include=(percentagecpu_sensor) and extend=(@table_name as table) and format=json and stat=false "SELECT DISTINCT(value) FROM ping_sensor ORDER BY value ASC"'
        headers = {
            'command': query % self.configs['dbms'],
            'User-Agent': 'AnyLog/1.23',
            'destination': 'network'
    ...
    def test_aggregates_count_distinct_value(self):
        ...
        """
        query = 'sql %s include=(percentagecpu_sensor) and extend=(@table_name as table) and format=json and stat=false "SELECT COUNT(DISTINCT(value)) FROM ping_sensor"'
        headers = {
            'command': query % self.configs['dbms'],
            'User-Agent': 'AnyLog/1.23',
            'destination': 'network'
    ...
    def test_aggregates_distinct_uuid(self):
        ...
        :assert:
            Distinct vales returned
        """
        query = ('sql %s include=(percentagecpu_sensor) and extend=(@table_name as table) and format=json and stat=false "SELECT DISTINCT(parentelement) FROM ping_sensor '
    ...
    def test_aggregates_distinct_string(self):
        ...
        :assert:
            Distinct vales returned
        """
        query = 'sql %s include=(percentagecpu_sensor) and extend=(@table_name as table) and format=json and stat=false "SELECT DISTINCT(device_name) FROM ping_sensor ORDER BY device_name ASC"'
        headers = {
            'command': query % self.configs['dbms'],
            'User-Agent': 'AnyLog/1.23',
            'destination': 'network'
    ...
    def test_aggregates_min_timestamp(self):
        ...
        :assert:
            min value returned
        """
        query = 'sql %s include=(percentagecpu_sensor) and extend=(@table_name as table) and format=json and stat=false "SELECT MIN(timestamp) FROM ping_sensor"'
        headers = {
            'command': query % self.configs['dbms'],
            'User-Agent': 'AnyLog/1.23',
            'destination': 'network'
    ...
    def test_aggregates_max_timestamp(self):
        ...
        :assert:
            max value returned
        """
        query = 'sql %s include=(percentagecpu_sensor) and extend=(@table_name as table) and format=json and stat=false "SELECT MAX(timestamp) FROM ping_sensor"'
        headers = {
            'command': query % self.configs['dbms'],
            'User-Agent': 'AnyLog/1.23',
            'destination': 'network'
    ...
    def test_group_by_uuid(self):
        ...
        """
        query = ('sql %s include=(percentagecpu_sensor) and extend=(@table_name as table) and format=json and stat=false '
    ...
    def test_where_by_uuid(self):
        ...
        query = 'sql %s include=(percentagecpu_sensor) and extend=(@table_name as table) and format=json and stat=false "' + sql_query + '"'
        headers = {
            'command': query % self.configs['dbms'],
            'User-Agent': 'AnyLog/1.23',
            'destination': 'network'
    ...
    def test_where_by_timestamp_desc(self):
        ...
        query = 'sql %s include=(percentagecpu_sensor) and extend=(@table_name as table) and format=json and stat=false "' + sql + '"'
        headers = {
            'command': query % self.configs['dbms'],
            'User-Agent': 'AnyLog/1.23',
            'destination': 'network'
    ...
    @pytest.mark.skip('Failed to execute increments with multiple tables')
